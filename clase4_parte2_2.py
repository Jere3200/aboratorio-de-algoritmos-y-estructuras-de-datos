...
lista_numeros_2 = [1,5,8,7,6,8,2,5,2,6,4,8,5,9,8,3,5,4,2,5,6,4]
suma_pares = 0
suma_impares = 0

for suma in lista_numeros_2:
    if suma % 2 == 0:
...
for numero in lista_numeros:
    if numero  < 0:
        print(f"Encontro un numero menor a 0 '{numero}'")
        break
    print(numero)
...
for numero in range(1,16):
    cuadrado = numero ** 2
    suma_de_cuadrados= suma_de_cuadrados + cuadrado
    print(f"El resultado es: {suma_de_cuadrados}")
...
for indice, nombre in enumerate(lista_nombres):
    if nombre.startswith("M"):
            print(f"Los nombres que empiezan con M son {nombre} y su indice es: {indice}")
