...
print("Estructura para evaluación")
print("Para conseguir este trabajo necesitas cumplir las siguientes dos condiciones.")

habla_ingles = input("¿Sabes inglés? Responde con 'Si' o con 'No': ")
sabe_python = input("¿Sabes Python? Responde con 'Si' o con 'No': ")

if habla_ingles == "Si" and sabe_python == "Si":
    print("Cumples con los requisitos para postularte")

elif habla_ingles == "No" and sabe_python == "Si":
    print("Para postularte, necesitas tener conocimientos de inglés.")

elif habla_ingles == "Si" and sabe_python == "No":
